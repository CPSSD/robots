...
//
// We adjust the motor speeds based on the total number of ticks and
// not just the number in each period.
//
...
int M1_Speed = 220; // Keep speed of M1 constant and adkust M2 as appropriate
int M2_Speed = 220;
...
void loop()
{
    if (M1_EncoderCount < ticksRequired) {
